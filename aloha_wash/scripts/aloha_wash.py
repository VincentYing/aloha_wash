...
def main():
    try:
        ...
        rospy.sleep(1) # Let arm motion catch up
        rrArm.go_to_joint_state((0, 14, 71, 0, 0, 0))

        input("============ Press `Enter` to spray ...")
        flArm.go_to_joint_state((-90, 105, 156, -50, 0, 0))
        rospy.sleep(2) # Let arm motion catch up
        flArm.go_to_joint_state((-134, 88, 143, -57, -18, 0))
        flArm.go_to_joint_state((-134, 64, 88, -23, -19, 0))
        rospy.sleep(2) # Let arm motion catch up
        flArm.go_to_joint_state((-76, 60, 70, -10, -8, 0))
